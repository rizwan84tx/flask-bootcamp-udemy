...
blueprint = make_google_blueprint(  client_id='310382293242-bluho0vuqhhjad11p87n3q27aftali5v.apps.googleusercontent.com',
                                    client_secret='8CLWjjNyZ55XnVyr5kKXOOr6',
                                    scope=['profile','email'] )
